...
public class Term implements Comparable<Term> {
	...
	public Term(String word, double weight) {
		if(word == null){
			throw new NullPointerException("There is no word");
		}
		if(weight < 0){
			throw new IllegalArgumentException("This word must have a positive weight");
		}
		myWord = word;
		myWeight = weight;
	}
	 ...
	 *
	 */
	public static class NativeSortingOrder implements Comparator<Term>{
		public int compare(Term o1, Term o2){
			return o1.myWord.compareTo(o2.myWord);
		}
	}
